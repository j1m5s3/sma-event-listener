from models.events import InvestAction
...
class SMAManagementLogicListenerInterface(BaseListenerInterface):
    """
    SMA Management Logic Listener Interface
    """
    ...
    def _unpack_event(self, event_dict: dict) -> dict:
        ...
        """
        event_model = InvestAction(raw_event=event_dict)
